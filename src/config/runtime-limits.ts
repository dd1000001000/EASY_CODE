...
export const runtimeLimitsSchema = z.object({
  ...
  subagentParentMessageMaxChars: integer(1024, 64000),
  ...
  memoryVectorMinSimilarity: z.number().finite().min(0).max(1),
  memoryConsolidationMatchLimit: integer(1, 20),
  memoryProjectExpiryDays: integer(1, 3650),
  memoryGlobalExpiryDays: integer(1, 3650),
  ...
  layaStartupTimeoutMs: integer(1000, 300000),
  layaDecisionTimeoutMs: integer(1000, 120000),
  layaIdleTimeoutMs: integer(1000, 3600000),
  layaDeliveryReleaseThreshold: z.number().finite().min(0).max(1),
