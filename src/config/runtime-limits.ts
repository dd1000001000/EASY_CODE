...
export const runtimeLimitsSchema = z.object({
  ...
  podmanImage: z.string().min(1).max(256).regex(/^[a-zA-Z0-9][a-zA-Z0-9._/:@-]*$/u),
  podmanMachineName: z.string().min(1).max(48).regex(/^[a-z][a-z0-9-]*$/u),
  podmanMachineMemoryMb: integer(2048, 131072),
  podmanMachineCpus: integer(1, 64),
  podmanMachineDiskGb: integer(10, 2048),
  podmanMemoryMb: integer(256, 131072),
  podmanCpus: integer(1, 64),
  podmanPidsLimit: integer(64, 65536),
  podmanShmMb: integer(16, 8192),
  podmanTmpMb: integer(64, 16384),
  podmanControlTimeoutMs: integer(1000, 300000),
  podmanSetupTimeoutMs: integer(60000, 3600000),
  podmanProxyMaxConnections: integer(1, 128),
  podmanProxyMaxBytes: integer(1048576, 1073741824),
  commandInspectTimeoutMaxMs: integer(1, 1200000),
  commandExecuteTimeoutMaxMs: integer(1, 1200000),
  commandInstallTimeoutMaxMs: integer(1, 1200000),
