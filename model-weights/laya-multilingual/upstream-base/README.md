...
Since laya 0.3.11 the default `Router()` keeps both `english` and this checkpoint resident, so a
...
Since laya 0.3.11 more text reaches this checkpoint: plain-ASCII Spanish, Italian, Portuguese and French
